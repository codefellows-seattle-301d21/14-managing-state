...
// COMMENT: What is this route doing? Where does it receive a request from?
// (The url request includes a parameter which we then pass to client.query method. The parameters are attached to the body as an object where each property of that object is passed as a parameter for a SQL query. The query updates specific values for the author table. After this process is complete, the same is done for the articles table. finally a completion response is returned.)
