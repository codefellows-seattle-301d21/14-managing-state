...
(function(module) {
  ...
  // this function grabs the text from the article-template id and uses it to compile the handlebars template. for the article passed in it renders the age the article, the published on date and the article body to the DOM. it is called on articleView.index function below.
