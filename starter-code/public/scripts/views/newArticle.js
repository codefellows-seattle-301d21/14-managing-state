...
(function(module) {
  ...
  // newArticle.initNewArticlePage calls newArticle.create and newArticle.submit from below, it takes input from new.html creates a new article and then saves it to app.Article.
